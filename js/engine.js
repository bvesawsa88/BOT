...
(function (root, factory) {
  ...
  const META_RICH_KEYS = [
    ...
    'hostBlockHumanShield', 'powerOnHumanShield', 'combatSurvivePowerMinus'
  ];
  ...
  const INHERIT_META_KEYS = [
    ...
    'powerOnHumanShield', 'combatSurvivePowerMinus'
  ];
